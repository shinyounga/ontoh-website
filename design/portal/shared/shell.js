  ...
  const SIDEBAR = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Voice & Tone',   href: 'foundations/voice-tone.html',    status: 'ready' },
        { label: 'Writing',        href: 'foundations/writing.html',       status: 'ready' },
        { label: 'State',          href: 'foundations/state.html',         status: 'ready' },
        { label: 'Layout',         href: 'foundations/layout.html',        status: 'ready' },
        { label: 'Accessibility',  href: 'foundations/accessibility.html', status: 'ready' },
      ]
    },
    {
      title: 'Components',
      ...
      links: [
        { label: 'Button',           href: 'components/button.html',            status: 'ready' },
        { label: 'Card',             href: 'components/card.html',              status: 'ready' },
        { label: 'Tag',              href: 'components/tag.html',               status: 'ready' },
        { label: 'Kicker',           href: 'components/kicker.html',            status: 'ready' },
        { label: 'Stat Number',      href: 'components/stat-number.html',       status: 'ready' },
        { label: 'Dropdown Link',    href: 'components/dropdown-link.html',     status: 'ready' },
        { label: 'Breadcrumb',       href: 'components/breadcrumb.html',        status: 'ready' },
        { label: 'Lightbox',         href: 'components/lightbox.html',          status: 'ready' },
        { label: 'Feature Carousel', href: 'components/feature-carousel.html',  status: 'ready' },
        { label: 'Alert',            href: 'components/alert.html',             status: 'ready' },
        { label: 'Form',             href: 'components/form.html',              status: 'ready' },
        { label: 'Navigation',       href: 'components/navigation.html',        status: 'ready' },
      ]
    },
    {
      title: 'Patterns',
