...
| **5대 현장 위험 유형** | 5 Detection Scenarios | 5가지 감지 · 5대 시나리오 (문맥 상 축약 OK) |
...
| **개구부 안전조치 미비** | 개구부 미설치 (섹션 3 통일 이전) · 개구부 위험 |
| **상하동시작업** | 상하 동시 작업 (띄어쓰기 X) · 상하 작업 |
| **중장비 위험구역 침범** | 중장비 접촉 · 협착 위험 (제200조 근거 · 실제 명칭은 "위험구역 침범") |

### 사용 규칙
- Feature 02 스트립·Feature 04 캐러셀·5대 현장 위험 유형 갤러리 모두 위 표준 명칭 사용
